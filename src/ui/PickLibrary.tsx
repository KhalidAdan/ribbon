    ...
    <main className="flex h-full items-center justify-center px-6">
      <div className="flex max-w-sm flex-col items-center gap-6 text-center">
        <div>
          ...
          <p className="mt-3 max-w-[45ch] text-base/7 text-pretty text-neutral-600 sm:text-sm/6 dark:text-neutral-400">Point Odio at a folder of audiobooks. It remembers where you are in every one, as a file beside the book.</p>
        </div>
